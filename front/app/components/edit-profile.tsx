	...
	return (
		<div className="rounded-lg bg-white p-6 shadow-md">
			...
			{isEditing ? (
				...
				<div className="space-y-4">
					<div>
						<p className="font-medium text-gray-700 text-sm">表示名</p>
						<p className="text-gray-900">{userProfile.displayName || '未設定'}</p>
					</div>
					<div>
						<p className="font-medium text-gray-700 text-sm">メールアドレス</p>
